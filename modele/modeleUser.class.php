...
class ModeleUser
{
    ...
    {
        session_start();
        // Vérifiez si l'utilisateur est un professionnel
        if ($_SESSION['role'] != 'clientPro') {
            echo "<p style='text-align: center;'>Accès non autorisé.</p>";
            return; // Arrêter l'exécution si l'utilisateur n'est pas un professionnel
        }
