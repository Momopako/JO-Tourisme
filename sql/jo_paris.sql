...
(
    ...
    idevenement    INT(3),  -- NULL si la réservation est pour un service
    idservice      INT(3),  -- NULL si la réservation est pour un événement
...
-- Réservation d'un événement par un utilisateur
INSERT INTO Reservation (iduser, idevenement, dateReservation, commentaire, statut)
VALUES (1, 1, CURDATE(), 'Réservation pour l'évènement natation.', 'confirmé');

-- Réservation d'un service par un utilisateur
INSERT INTO Reservation (iduser, idservice, dateReservation, commentaire, statut)
VALUES (1, 1, CURDATE(), 'Réservation pour l'hôtel Novotel.', 'confirmé');
